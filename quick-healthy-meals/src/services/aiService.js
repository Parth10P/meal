...
class AIService {
  constructor(apiKey = 'AIzaSyCE-jLnrw35ZmSfV748NDTwHGw9d-VVJeI', provider = 'gemini') {
    this.apiKey = apiKey
  ...
  static validateAPIKey(apiKey = 'AIzaSyCE-jLnrw35ZmSfV748NDTwHGw9d-VVJeI', provider = 'gemini') {
